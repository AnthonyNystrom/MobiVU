...
#define FFMPEG_CONFIGURATION " --arch=arm --cross-compile --disable-protocols --disable-encoders --disable-decoders --disable-muxers --disable-demuxers --disable-parsers --enable-encoder=mpeg1video "
#define ARCH_ARM 1
