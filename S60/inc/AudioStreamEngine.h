 ...
 */
    static CAudioStreamEngine* NewL(CDemoVideoCallAppUi* /* aAppUi */);
 ...
 */
    static CAudioStreamEngine* NewLC(CDemoVideoCallAppUi* /* aAppUi */);
 ...
 */
    CAudioStreamEngine(CDemoVideoCallAppUi* /* aAppUi */);
