...
#ifdef __CW32__
	{"yuv420p",		3, FF_COLOR_YUV, FF_PIXEL_PLANAR, 0, 1, 1, 8, }, /* PIX_FMT_YUV420P */
	{"yuyv422",		1, FF_COLOR_YUV, FF_PIXEL_PACKED, 0, 1, 0, 8, }, /* PIX_FMT_YUYV422 */
	{"rgb24",		3, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 8, }, /* PIX_FMT_RGB24 */
	{"bgr24",		3, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 8, }, /* PIX_FMT_BGR24 */
	{"yuv422p",		3, FF_COLOR_YUV, FF_PIXEL_PLANAR, 0, 1, 0, 8, }, /* PIX_FMT_YUV422P */
	{"yuv444p",		3, FF_COLOR_YUV, FF_PIXEL_PLANAR, 0, 0, 0, 8, }, /* PIX_FMT_YUV444P */
	{"rgb32",		4, FF_COLOR_RGB, FF_PIXEL_PACKED, 1, 0, 0, 8, }, /* PIX_FMT_RGB32 */
	{"yuv410p",		3, FF_COLOR_YUV, FF_PIXEL_PLANAR, 0, 2, 2, 8, }, /* PIX_FMT_YUV410P */
	{"yuv411p",		3, FF_COLOR_YUV, FF_PIXEL_PLANAR, 0, 2, 0, 8, }, /* PIX_FMT_YUV411P */
	{"rgb565",		3, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 5, }, /* PIX_FMT_RGB565 */
	{"rgb555",		3, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 5, }, /* PIX_FMT_RGB555 */
	{"gray",		1, FF_COLOR_GRAY, FF_PIXEL_PLANAR, 0, 0, 0, 8, }, /* PIX_FMT_GRAY8 */
	{"monow",		1, FF_COLOR_GRAY, FF_PIXEL_PLANAR, 0, 0, 0, 1, }, /* PIX_FMT_MONOWHITE */
	{"monob",		1, FF_COLOR_GRAY, FF_PIXEL_PLANAR, 0, 0, 0, 1, }, /* PIX_FMT_MONOBLACK */
	{"pal8",		4, FF_COLOR_RGB, FF_PIXEL_PALETTE, 1, 0, 0, 8, }, /* PIX_FMT_PAL8 */
	{"yuvj420p",	3, FF_COLOR_YUV_JPEG, FF_PIXEL_PLANAR, 0, 1, 1, 8, }, /* PIX_FMT_YUVJ420P */
	{"yuvj422p",	3, FF_COLOR_YUV_JPEG, FF_PIXEL_PLANAR, 0, 1, 0, 8, }, /* PIX_FMT_YUVJ422P */
	{"yuvj444p",	3, FF_COLOR_YUV_JPEG, FF_PIXEL_PLANAR, 0, 0, 0, 8, }, /* PIX_FMT_YUVJ444P */
	{"xvmcmc",		0, 0, 0, 0, 0, 0, 0, }, /* PIX_FMT_XVMC_MPEG2_MC */
	{"xvmcidct",	0, 0, 0, 0, 0, 0, 0, }, /* PIX_FMT_XVMC_MPEG2_IDCT */
	{"uyvy422",		1, FF_COLOR_YUV, FF_PIXEL_PACKED, 0, 1, 0, 8, }, /* PIX_FMT_UYVY422 */
	{"uyyvyy411",	1, FF_COLOR_YUV, FF_PIXEL_PACKED, 0, 2, 0, 8, }, /* PIX_FMT_UYYVYY411 */
	{"bgr32",		4, FF_COLOR_RGB, FF_PIXEL_PACKED, 1, 0, 0, 8, }, /* PIX_FMT_BGR32 */
	{"bgr565",		3, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 5, }, /* PIX_FMT_BGR565 */
	{"bgr555",		3, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 5, }, /* PIX_FMT_BGR555 */
	{"bgr8",		1, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 8, }, /* PIX_FMT_BGR8 */
	{"bgr4",		1, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 4, }, /* PIX_FMT_BGR4 */
	{"bgr4_byte",	1, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 8, }, /* PIX_FMT_BGR4_BYTE */
	{"rgb8",		1, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 8, }, /* PIX_FMT_RGB8 */
	{"rgb4",		1, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 4, }, /* PIX_FMT_RGB4 */
	{"rgb4_byte",	1, FF_COLOR_RGB, FF_PIXEL_PACKED, 0, 0, 0, 8, }, /* PIX_FMT_RGB4_BYTE */
	{"nv12",		2, FF_COLOR_YUV, FF_PIXEL_PLANAR, 0, 1, 1, 8, }, /* PIX_FMT_NV12 */
	{"nv12",		2, FF_COLOR_YUV, FF_PIXEL_PLANAR, 0, 1, 1, 8, }, /* PIX_FMT_NV21 */
	{"rgb32_1",		4, FF_COLOR_RGB, FF_PIXEL_PACKED, 1, 0, 0, 8, }, /* PIX_FMT_RGB32_1 */
	{"bgr32_1",		4, FF_COLOR_RGB, FF_PIXEL_PACKED, 1, 0, 0, 8, }, /* PIX_FMT_BGR32_1 */
	{"gray16be",	1, FF_COLOR_GRAY, FF_PIXEL_PLANAR, 0, 0, 0, 16, }, /* PIX_FMT_GRAY16BE */
	{"gray16le",	1, FF_COLOR_GRAY, FF_PIXEL_PLANAR, 0, 0, 0, 16, }, /* PIX_FMT_GRAY16LE */
	{"yuv440p",		3, FF_COLOR_YUV, FF_PIXEL_PLANAR, 0, 0, 1, 8, }, /* PIX_FMT_YUV440P */
	{"yuvj440p",	3, FF_COLOR_YUV_JPEG, FF_PIXEL_PLANAR, 0, 0, 1, 8, }, /* PIX_FMT_YUVJ440P */
	{"yuva420p",	4, FF_COLOR_YUV, FF_PIXEL_PLANAR, 0, 1, 1, 8, }, /* PIX_FMT_YUVA420P */
#else
    /* YUV formats */
    [PIX_FMT_YUV420P] = {
        .name = "yuv420p",
