 ...
 * -------------------------------------------------------------------
 */
#ifndef CCYUV420TOYUV422_H_INCLUDED
#define CCYUV420TOYUV422_H_INCLUDED
...
class CCYUV420toYUV422 : public ColorConvertBase
{

    public:

        OSCL_IMPORT_REF static ColorConvertBase* New();
        OSCL_IMPORT_REF ~CCYUV420toYUV422();
...
#endif // CCYUV420TOYUV422_H_INCLUDED
