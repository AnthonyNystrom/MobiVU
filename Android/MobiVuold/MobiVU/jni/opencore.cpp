...
// VIDEO ENCODER ******************************
	jint Java_com_mobivu_Codecs_InitEncoderVideo(JNIEnv*  env, jobject  thiz, jint iWidth, jint iHeight)
...
// VIDEO DECODER ******************************
	jint Java_com_mobivu_Codecs_InitDecoderVideo(JNIEnv*  env, jobject  thiz, jint iWidth, jint iHeight)
	{		
