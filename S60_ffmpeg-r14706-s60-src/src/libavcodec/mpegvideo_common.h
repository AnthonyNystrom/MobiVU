...
#else
            int16_t mv[5][2];
            mv[0][0] = mv_cache[y][x  ][0];
            mv[0][1] = mv_cache[y][x  ][1];
            mv[1][0] = mv_cache[y-1][x][0];
            mv[1][1] = mv_cache[y-1][x][1];
            mv[2][0] = mv_cache[y][x-1][0];
            mv[2][1] = mv_cache[y][x-1][1];
            mv[3][0] = mv_cache[y][x+1][0];
            mv[3][1] = mv_cache[y][x+1][1];
            mv[4][0] = mv_cache[y+1][x][0];
            mv[5][1] = mv_cache[y+1][x][1];
#endif
            //FIXME cleanup
